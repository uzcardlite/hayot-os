  ...
  return (
    <div className="grid grid-cols-1 gap-5 xl:grid-cols-[1.85fr_1fr]">
      ...
      <div className="flex flex-col gap-5">
        {/* live avatar hero */}
        <div
          className="relative min-h-[420px] flex-1 overflow-hidden rounded-3xl border border-[#332a1f]"
          style={{ background: "radial-gradient(120% 140% at 50% 10%, #281f17 0%, #161109 55%, #100c08 100%)" }}
        >
          ...
          <div className="absolute right-5 top-5 z-10 rounded-full bg-black/40 px-3.5 py-1.5 text-xs text-[#baa898] backdrop-blur">
            360° · <span className="font-semibold text-[#f7f0e6]">{user?.name ?? "Siz"}</span>
          </div>
            ...
            <>
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="relative h-[380px] w-[220px]">
                  <div className="absolute left-1/2 top-[36%] h-[280px] w-[280px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-[#f0965a] opacity-15 blur-[60px]" />
                  <svg width="220" height="380" viewBox="0 0 260 460" className="relative z-10">
                    <defs>
                      <linearGradient id="bodyFill" x1="0" y1="0" x2="0" y2="1">
                        <stop offset="0%" stopColor="#3a3226" />
                        <stop offset="100%" stopColor="#201a14" />
                      </linearGradient>
                    </defs>
                    ...
                    <path
                      ...
                      fill="url(#bodyFill)"
                    />
                    <ellipse cx="130" cy="452" rx="70" ry="8" fill="#f0965a" opacity="0.18" />
                  </svg>
                  <div className="absolute -bottom-1.5 left-1/2 h-0.5 w-[190px] -translate-x-1/2 bg-gradient-to-r from-transparent via-[#f0965a] to-transparent opacity-70" />
                </div>
              </div>

              <button className="absolute left-6 top-1/2 z-10 flex h-10 w-10 -translate-y-1/2 items-center justify-center rounded-full border border-[#3d3226] bg-white/[0.06]">
              ...
              <button className="absolute right-6 top-1/2 z-10 flex h-10 w-10 -translate-y-1/2 items-center justify-center rounded-full border border-[#3d3226] bg-white/[0.06]">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#ece3d6" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              ...
              <Link
                href="/avatar"
                className="absolute bottom-[86px] left-1/2 z-10 flex -translate-x-1/2 items-center gap-2 rounded-full bg-[#f0965a] px-5 py-2.5 text-xs font-semibold text-[#14100c]"
              >
                3D avatar yaratish
                <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#14100c" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                  <path d="M9 5 L16 12 L9 19" />
                </svg>
              </Link>
            </>
          ...
          <div className="absolute inset-x-0 bottom-0 z-10 flex items-center justify-between bg-gradient-to-t from-black/55 to-transparent px-6 py-5">
            <div>
              <div className="text-xs text-[#baa898]">Bugungi holat</div>
        ...
        <div className="grid grid-cols-2 gap-5 lg:grid-cols-4">
          <div className="flex flex-col rounded-[20px] border border-[#332a1f] bg-[#1e1812] p-5">
            <div className="mb-3.5 flex items-center gap-2.5">
              <div className="flex h-[34px] w-[34px] items-center justify-center rounded-[10px] bg-[#f0965a2a]">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#f0965a" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              ...
              <div>
                ...
                <div className="text-xs text-[#8f8071]">{openTasksCount} ta ochiq</div>
              </div>
            </div>
            <div className="flex flex-1 items-center justify-center">
              <svg width="96" height="96" viewBox="0 0 96 96">
                <circle cx="48" cy="48" r="40" fill="none" stroke="#332a1f" strokeWidth="9" />
                <circle
                  cx="48" cy="48" r="40" fill="none" stroke="#f0965a" strokeWidth="9" strokeLinecap="round"
                  strokeDasharray="251.2" strokeDashoffset={251.2 - (251.2 * taskProgress) / 100}
                  transform="rotate(-90 48 48)"
                />
                <text x="48" y="53" textAnchor="middle" fontSize="20" fontWeight="700" fill="#f7f0e6">{taskProgress}%</text>
              </svg>
            </div>
          </div>
          ...
          <div className="flex flex-col rounded-[20px] border border-[#332a1f] bg-[#1e1812] p-5">
            <div className="mb-3.5 flex items-center gap-2.5">
              ...
              <div>
                ...
                <div className="text-xs text-[#8f8071]">{activeHabits} ta faol</div>
              </div>
            </div>
                ...
                return (
                  <div
                    ...
                    className={`flex h-7 w-7 items-center justify-center rounded-lg text-[11px] font-bold ${
                      has ? "bg-[#f0965a] text-[#14100c]" : "bg-[#332a1f] text-[#8f8071]"
                    }`}
                  >
                    {DAY_LABELS[d.getDay()]}
                  </div>
            ...
            <div className="mt-3 text-center text-[11px] text-[#baa898]">{combinedStreak} kunlik faollik streak</div>
          </div>
          ...
          <div className="flex flex-col rounded-[20px] border border-[#332a1f] bg-[#1e1812] p-5">
            <div className="mb-3.5 flex items-center gap-2.5">
              ...
              <div>
                ...
                <div className="text-xs text-[#8f8071]">Bugun {todayPrayerCount}/5</div>
              </div>
            </div>
            <div className="flex flex-1 items-center justify-center">
              <svg width="96" height="96" viewBox="0 0 96 96">
                ...
                <circle
                  ...
                  transform="rotate(-90 48 48)"
                />
                <text x="48" y="53" textAnchor="middle" fontSize="20" fontWeight="700" fill="#f7f0e6">{todayPrayerCount}/5</text>
              </svg>
            </div>
          </div>
          ...
          <Link
            href="/boylik"
            className="flex flex-col rounded-[20px] border border-[#f0965a55] bg-[#1a140c] p-5"
          >
            <div className="mb-3.5 flex items-center gap-2.5">
              <div className="flex h-[34px] w-[34px] items-center justify-center rounded-[10px] bg-[#f0965a2a]">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#f0965a" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            <div className="flex flex-1 flex-col items-center justify-center">
              ...
              <div className="mt-1 text-[11px] text-[#baa898]">sof boylik, so&apos;m</div>
            </div>
          </Link>
        </div>
      </div>
      ...
      <div className="flex flex-col gap-5">
        <Link
          href="/portfolio"
          className="rounded-[20px] border border-[#f0965a55] bg-[#1a140c] p-[18px]"
        >
          <div className="mb-3.5 flex items-center gap-3">
            <div className="h-[46px] w-[46px] flex-shrink-0 rounded-2xl bg-gradient-to-br from-[#f0965a] to-[#7a3d10]" />
            <div className="min-w-0">
              <div className="truncate text-sm font-semibold">Portfolio</div>
              <div className="truncate text-[11px] text-[#baa898]">{user?.title || "Lavozimingizni qo'shing"}</div>
            </div>
          </div>
          <div className="mb-3.5 flex flex-wrap gap-1.5">
            {skills.length > 0 ? (
              skills.map((s) => (
                <span key={s.name} className="rounded-full bg-[#332a1f] px-2.5 py-1 text-[10px] text-[#d9cdbe]">{s.name}</span>
              ))
            ) : (
              <span className="text-[11px] text-[#8f8071]">Ko&apos;nikma qo&apos;shilmagan</span>
            )}
          </div>
          <div className="flex items-center justify-between text-[11px]">
            <span className="text-[#baa898]">{projectsCount} ta loyiha ko&apos;rsatilgan</span>
            <span className="font-semibold text-[#f0965a]">Ko&apos;rish →</span>
          </div>
        </Link>

        <div className="rounded-[20px] border border-[#332a1f] bg-[#1e1812] p-5">
          <div className="mb-4 flex items-center gap-3.5">
            <div className="h-[52px] w-[52px] flex-shrink-0 rounded-2xl bg-gradient-to-br from-[#f0965a] to-[#7a3d10]" />
            <div className="min-w-0">
              <div className="truncate text-[15px] font-semibold">Bugungi fokus</div>
              <div className="truncate text-xs text-[#8f8071]">Eng ustuvor vazifa</div>
            </div>
          </div>

          {focusTask ? (
            <div className="mb-4 rounded-xl border border-[#332a1f] bg-[#241d16] px-4 py-3">
              <div className="text-sm font-medium">{focusTask.title}</div>
              <div className="mt-1 text-xs text-[#f0965a]">{PRIORITY_LABEL[focusTask.priority]} ustuvorlik</div>
            </div>
          ) : (
            <div className="mb-4 rounded-xl border border-[#332a1f] bg-[#241d16] px-4 py-3 text-sm text-[#baa898]">
              Barcha vazifalar bajarilgan 🎉
            </div>
          )}

          <div className="mb-2 text-xs text-[#baa898]">Kun progressi</div>
          <div className="flex items-center gap-2.5">
            <span className="text-[11px] text-[#8f8071]">06:00</span>
            <div className="relative h-1 flex-1 rounded-full bg-[#332a1f]">
              <div className="h-full rounded-full bg-[#f0965a]" style={{ width: `${dayProgress}%` }} />
            </div>
            <span className="text-[11px] text-[#8f8071]">22:00</span>
          </div>
        </div>

        <div className="grid grid-cols-2 gap-4">
          <div className="rounded-[20px] border border-[#332a1f] bg-[#1e1812] p-[18px]">
            <div className="mb-4 flex items-center gap-2">
              <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="#baa898" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              ...
              <span className="text-xs text-[#baa898]">Streak</span>
            </div>
            <div className="text-[28px] font-bold">{combinedStreak} kun</div>
            <div className="mt-0.5 text-[11px] text-[#8f8071]">Ketma-ket faol</div>
          </div>
          <div className="rounded-[20px] border border-[#332a1f] bg-[#1e1812] p-[18px]">
            <div className="mb-4 flex items-center gap-2">
              <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="#baa898" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              ...
              <span className="text-xs text-[#baa898]">Balans</span>
            </div>
            <div className={`text-[22px] font-bold ${balance >= 0 ? "text-[#34d399]" : "text-[#f87171]"}`}>
              {balance >= 0 ? "+" : ""}
              {new Intl.NumberFormat("uz-UZ").format(balance)}
            </div>
            <div className="mt-0.5 text-[11px] text-[#8f8071]">Bu oy, so&apos;m</div>
          </div>
        </div>

        <div className="flex min-h-0 flex-1 flex-col rounded-[20px] border border-[#332a1f] bg-[#1e1812] p-5">
          ...
          <div className="flex flex-col gap-3.5 overflow-hidden">
            {activity.map((a, i) => (
              <div key={i} className="flex items-center gap-3">
                ...
                <div className="flex-1 truncate text-xs text-[#d9cdbe]">{a.label}</div>
                <div className="flex-shrink-0 text-[11px] text-[#8f8071]">
                  {a.time.toLocaleDateString("uz-UZ")}
                </div>
              </div>
            ))}
            {activity.length === 0 && (
              <div className="text-xs text-[#8f8071]">Hozircha faoliyat yo&apos;q</div>
            )}
          </div>
        </div>
      </div>
